...
<#import "user-profile-commons-custom.ftl" as userProfileCommonsCustom>
...
<@layout.registrationLayout displayMessage=messagesPerField.exists('global') displayRequiredFields=true; section>
    ...
    <#elseif section = "form">
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            ...
            <@userProfileCommonsCustom.userProfileFormFieldsCustom; callback, attribute>
            ...
            </@userProfileCommonsCustom.userProfileFormFieldsCustom>
            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                    <input class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" type="submit" value="${msg("doRegister")}" id="submit-button" disabled/>
                </div>
