    ...
    >
      <Grid item xs={12} md={6}>
        ...
        <Grid item textAlign="left" sx={{ my: 2 }}>
          ...
          <Typography variant="body1">
            本実証実験において収集される情報は、サービス提供事業者であるTISI株式会社および
          ...
          <Typography variant="body1">
            ・本サービスを利用した営業活動
            <br />
            ・TISI株式会社および{TERMS_MUNICIPALITY_NAME}
            による本サービスの運営を妨害する行為
            <br />
            ・他のユーザ、第三者の権利を侵害する行為
          </Typography>
          ...
          <Typography variant="body1">
            ・活動を行う際には、ご自身の健康状態を十分に管理ください。
            <br />
            ・体調がすぐれない場合や、医師から運動を控えるように指示されている場合は、参加を控えてください。
            <br />
            ・適切な水分補給と休憩を心がけ、無理のない範囲で活動を行ってください。
            <br />
