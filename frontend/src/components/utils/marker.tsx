...
export const red0Icon = createColoredIcon('#ff7a7a')
...
export const blue0Icon = createColoredIcon('#7abcff')
...
export const green0Icon = createColoredIcon('#7aff7a')
...
export const yellow0Icon = createColoredIcon('#ffff7a')
...
export const orange0Icon = createColoredIcon('#ffbc7a')
...
export const violet0Icon = createColoredIcon('#bc7aff')
